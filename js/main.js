...
//   gsap.to(window, 0.6, {
//     scrollTo: 0 // 페이지의 0px 지점 (최상단)으로 이동, ScrollToPulgin을 연결해야 사용 가능한 옵션
//   });
// });
...
new Swiper('.promotion .swiper', {
  ...
  loop: true, // 반복 재생 여부, 1 -> 2 -> 3 -> 4 -> 다시 1
  autoplay: {
    delay: 5000 // 5초다 슬라이드 바뀜(기본값: 3000)
  },
...
spyEls.forEach(function (spyEl) {
  new ScrollMagic.Scene({ // 감시할 장면(Scene) 추가 및 옵셥 지정
...
thisYearEl.textContent = new Date().getFullYear(); //현재 연도의 정보가 숫자 데이터로 반환됨
